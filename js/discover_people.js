...
function Patient (f_name, l_name, user, pass, age, ints, pic, med_id) {
...
var swag = new Patient(curr_name, curr_name, curr_user, curr_pass, curr_age, curr_ints, curr_pic, 1122332);


var Navya = new Patient("Navya", "Kalale", "nva", "cscscs", 12, ["Soccer", "Art", "Fortnite", "fubol"], "hoes.jpg");

var Monica = new Patient("Monica", "Chang", "mchang", "Mon", 10, ["History","Dancing","Fortnite"], "itME.jpg")

var Nikhila = new Patient("Nikhila", "Vembu", "nvembu", "Tequila", 12, ["Piano","Memes","Math"], "sos.jpg");

var Aldrich = new Patient("Aldrich", "Ronquillo", "alpal", "Buzz", 7, ["Piano","Math","History"], "yikes.jpg");
